---
title: "A really not so simple doc"
author: "Madeline"
output:
    html_document:
      toc: true
...
```{r}
samp = rnorm(100) #this samples from a normal distriburion
length(samp)
```
...
This plot shows the distribution of teh absolute value of $X \sim N(1,1)$.
